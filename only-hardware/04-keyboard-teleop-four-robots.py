"""
04-keyboard-teleop-four-robots.py - Keyboard teleop for four SO-100/101 follower arms (hardware only)
==============================================================================
Direct per-joint keyboard control of four real follower arms. No simulation.

Usage:
    python 04-keyboard-teleop-four-robots.py \
        --port1 COMx --port2 COMx --port3 COMx --port4 COMx
...
def main():
    p = argparse.ArgumentParser(description="Hardware keyboard teleop for four arms")
    ...
    ports = [args.port1, args.port2, args.port3, args.port4]
    ids = [args.id1, args.id2, args.id3, args.id4]
    labels = ["follower1", "follower2", "follower3", "follower4"]
